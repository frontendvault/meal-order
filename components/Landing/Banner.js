          ...
          <div className="absolute bg-slate-900/[.80] h-full w-full top-0 flex items-center justify-center">
            <div className=" z-9">
              ...
              <div className="items center justify-center flex mt-10 space-x-10">
                <Link href="/menu">
                  <button className="py-3 px-8 rounded bg-blue-700 hover:bg-blue-800 text-white font-normal shadow-lg">
                    Meal Prep
                  </button>
                </Link>
                <Link href="/placeorder">
                  <button className="py-3 px-8 rounded bg-white text-blue-700 hover:bg-blue-700 hover:text-white font-normal shadow-lg">
                    Order Now
                  </button>
                </Link>
              </div>
