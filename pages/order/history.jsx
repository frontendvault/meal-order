                  ...
                  <div className="text-right flex lg:flex-row flex-col lg:gap-4 gap-2 items-center">
                    <div className="relative w-full">
                      ...
                      <input
                        type="text"
                        id="simple-search"
                        className="bg-white border border-dashed border-blue-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 outline-none focus:outline-none"
                        placeholder=""
                        required
                      />
                    </div>
                    <div className="flex gap-4 justify-between w-full lg:w-full">
                      <div className="lg:w-auto w-1/2">
                        <button className="lg:min-w-[8rem] w-full bg-white border border-blue-700 text-blue-700 text-sm rounded-lg  block p-2.5">
                          Search Orders
                        </button>
                      </div>
                      <div className="lg:w-auto w-1/2">
                        <button className="lg:min-w-[8rem] w-full border border-blue-700 bg-blue-100 text-blue-700 text-sm rounded-lg  block p-2.5">
                          Button Text
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="table-fixed w-full text-left">
                    <div className="bg-blue-700 text-white mb-4 text-xl rounded-lg">
                      <div className="lg:flex hidden w-full">
                        ...
                        <div className="py-4 px-4 text-left w-full lg:w-[50%]">
                          Items
                        </div>
                        <div className="py-4 px-4 text-left w-full lg:w-[20%]">
                          Reviews
                    ...
                    <div>
                      {items?.map((e, i) => {
                        return (
                          <>
                            {!collapsedItems.includes(i) && <div
                              className={`cursor-pointer group flex lg:flex-row flex-col w-full mb-4 bg-blue-100 text-blue-700 bg-blue-100 ${!collapsedItems.includes(i) ? "show" : "hide"} `}
                              // className={`collapse-content ${collapsedItems.includes(i) ? 'collapsed' : "cursor-pointer group flex lg:flex-row flex-col w-full mb-4 bg-blue-100 text-blue-700 bg-blue-100"}`}
                              key={i}
                            ...
                            >
                              <div className="py-4 px-4 text-left w-full lg:w-[20%] ease-in-out transisition duration-300 group-hover:bg-yellow-500">
                                <div className="flex gap-4 items-center">
                                  ...
                                  <div className="grow">
                                    <h4 className="text-blue-700 font-lg font-bold">
                                      Order Name
                                    </h4>
                                ...
                                <div className="grid lg:grid-cols-3 grid-cols-1">
                                  {items?.map((e, i) => {
                                    return (
                                      ...
                                      >
                                        <h4 className="text-blue-700 ease-in-out transisition duration-300 group-hover:text-white font-lg font-bold">
                                          Heading
                                        </h4>
                                        <p className="text-sm text-blue-500 ease-in-out transisition duration-300 group-hover:text-white">
                                          Caption Text
                                        </p>
                                      </div>
                                    );
                              ...
                              <div className="py-4 px-4 text-left w-full lg:w-[10%]">
                                <button className="w-full border border-dashed border-blue-700 bg-blue-100 text-blue-700 text-sm rounded-lg block p-2.5">
                                  Button Text
                                </button>
                              </div>
                            </div>}
                            ...
                            {collapsedItems.includes(i) && <div className={`pt-4 lg:pb-20 pb-8 ${!collapsedItems.includes(i) ? "hide" : "show"} `}>
                              <div
                                ...
                                onClick={() => toggleCollapse(i)}
                                // className={`collapse-content ${!collapsedItems.includes(i) ? 'collapsed' : "bg-yellow-500  flex w-full mb-8 text-yellow-500 cursor-pointer"}`}
                              >
                              ...
                              <div className="cursor-pointer lg:gap-12 gap-4 flex lg:flex-row flex-col w-full lg:p-6 p-4 mt-8 mb-4 text-white bg-blue-700">
                                <div className="text-left lg:w-[20%] w-full">
                                  ...
                                  <p className="text-sm">
                                    54-22 Costa Arroya Lane, Jaxonivillla, Florida
                                  </p>
                                ...
                                <div className="text-left lg:w-[40%] w-full">
                                  ...
                                  <p className="text-sm">
                                    &quot;Loved the thanksgiving! The Unwrapped burrito was a
                                    bit messy, but enjoyed it as well&quot;
                                  </p>
